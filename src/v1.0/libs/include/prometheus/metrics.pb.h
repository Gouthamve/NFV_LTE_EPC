...
class Gauge : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:io.prometheus.client.Gauge) */ {
 public:
  ...
  inline Gauge* New() const PROTOBUF_FINAL { return New(NULL); }

  Gauge* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class Quantile : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:io.prometheus.client.Quantile) */ {
 public:
  ...
  inline Quantile* New() const PROTOBUF_FINAL { return New(NULL); }

  Quantile* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  void set_has_quantile();
  void clear_has_quantile();
  void set_has_value();
  void clear_has_value();
...
class Summary : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:io.prometheus.client.Summary) */ {
 ...
 private:
  void set_has_sample_count();
  void clear_has_sample_count();
  void set_has_sample_sum();
  void clear_has_sample_sum();
...
class Untyped : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:io.prometheus.client.Untyped) */ {
 public:
  ...
  inline Untyped* New() const PROTOBUF_FINAL { return New(NULL); }

  Untyped* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class Bucket : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:io.prometheus.client.Bucket) */ {
 ...
 private:
  void set_has_cumulative_count();
  void clear_has_cumulative_count();
...
class MetricFamily : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:io.prometheus.client.MetricFamily) */ {
 public:
  ...
  inline MetricFamily* New() const PROTOBUF_FINAL { return New(NULL); }

  MetricFamily* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
inline const ::io::prometheus::client::Histogram& Metric::histogram() const {
  ...
  return histogram_ != NULL ? *histogram_
